...
<template>
  <q-page>
    ...
    <q-card-section class="text-h7" style="background-color: rgb(255, 228, 196)">
      <ul>
        <li><span>Szin: </span><b>{{ item.szin }}</b></li>
        <li><span>Évjárat: </span><b>{{ item.evjarat }}</b></li>
        <li><span>Hengerűrtartalom: </span><b>{{ item.hengerurtartalom }}</b></li>
        <li><span>Hirdetés dátuma: </span><b>{{ item.hirdetes_datum }}</b></li>
      </ul>
    </q-card-section>
